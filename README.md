...
|---------|-------------|------|
| [`Elica Connect Plus`](https://github.com/marturano/elica-connect-plus) | Home Assistant custom integration for Elica connected kitchen hoods — control fan speed, lighting and monitor status directly from Home Assistant and Alexa devices | Home Assistant · Python · Alexa · HACS |
| [`Setecna Reg Plus`](https://github.com/marturano/setecna-reg-plus) | Home Assistant custom application for Setecna Reg System — control climate, ACS and thermostat directly from Home Assistant and Alexa devices | Home Assistant · Python · Go · Alexa |
